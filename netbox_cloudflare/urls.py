...
urlpatterns = [
    ...
    *_crud(
        ...
        views.CloudflareMonitorView,
        views.CloudflareMonitorListView,
        views.CloudflareMonitorEditView,
        views.CloudflareMonitorDeleteView,
        views.CloudflareMonitorBulkDeleteView,
    ),
    *_crud(
        "lb-pools",
        "cloudflarelbpool",
        models.CloudflareLBPool,
        views.CloudflareLBPoolView,
        views.CloudflareLBPoolListView,
        views.CloudflareLBPoolEditView,
        views.CloudflareLBPoolDeleteView,
        views.CloudflareLBPoolBulkDeleteView,
    ),
    *_crud(
        "lb-origins",
        "cloudflarelborigin",
        models.CloudflareLBOrigin,
        views.CloudflareLBOriginView,
        views.CloudflareLBOriginListView,
        views.CloudflareLBOriginEditView,
        views.CloudflareLBOriginDeleteView,
        views.CloudflareLBOriginBulkDeleteView,
    ),
    *_crud(
        "load-balancers",
        "cloudflareloadbalancer",
        models.CloudflareLoadBalancer,
        views.CloudflareLoadBalancerView,
        views.CloudflareLoadBalancerListView,
        views.CloudflareLoadBalancerEditView,
        views.CloudflareLoadBalancerDeleteView,
        views.CloudflareLoadBalancerBulkDeleteView,
    ),
    *_crud(
        "lb-default-pools",
        "cloudflarelbdefaultpool",
        models.CloudflareLBDefaultPool,
        views.CloudflareLBDefaultPoolView,
        views.CloudflareLBDefaultPoolListView,
        views.CloudflareLBDefaultPoolEditView,
        views.CloudflareLBDefaultPoolDeleteView,
        views.CloudflareLBDefaultPoolBulkDeleteView,
    ),
]
